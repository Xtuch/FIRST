...
@Autonomous(name = "AutoAzul", group = "Concept")
...
public class AutoAzul extends LinearOpMode {
    ...
    private static final String TFOD_MODEL_ASSET = "model_20240131_160557.tflite";
    // TFOD_MODEL_FILE points to a model file stored onboard the Robot Controller's storage,
    // this is used when uploading models directly to the RC using the model upload interface.
    private static final String TFOD_MODEL_FILE = "/sdcard/FIRST/tflitemodels/model_20240131_160557.tflite";
